...
//	public static LoginPage loginPage;
	...
	public TestBase() {
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("C:\\Users\\GLB-BLR-015\\Desktop\\Mahantesh\\eclipse-workspace\\PowerDAO\\src\\main\\java\\com\\power\\qa\\config\\config.properties");
			prop.load(ip);
